...
require "pipegem/version"

Gem::Specification.new do |spec|
  spec.name          = "pipegem"
  spec.version       = Pipegem::VERSION
  spec.authors       = ["Daniel Morales Miguel"]
  ...
  if spec.respond_to?(:metadata)
    spec.metadata["allowed_push_host"] = "git@github.com:danalex93/pipegem.git"
  else
